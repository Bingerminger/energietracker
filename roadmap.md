...
> **Kurzfassung.** Jetzt: v2.15.0 — Diagramme, die stimmen. Als Nächstes:
> Diagramme, die mehr zeigen (v2.16.0: witterungsbereinigt, Saldo-Verlauf,
> PV-Energiefluss). Danach: Nebenkostenabrechnung für Mieter
...
>
> *In English:* now v2.15.0 (charts that are right); next charts that show more
> (v2.16.0: weather-adjusted, balance over time, PV energy flow);
...
**Stand:** 2026-09-25 (synchron mit v2.15.0; Pakete A, B, Länderprofile, C, D, E und F1 aus dem Gesamtreview)
**Aktuelle Baseline:** v2.15.0
**Schema:** 1.6.0
