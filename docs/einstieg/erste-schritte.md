...
[English](../en/einstieg/erste-schritte.md) · **Deutsch**
...
Apache, nginx — stehen in [Installation](../betrieb/installation.md) und
...
- **Auswertungen → Analyse:** Verbrauch gegen Heizgradtage (Heizsignatur), mit
  Regressionsgerade und R²-Vergleich von fünf Modellen.
...
- **Werte automatisch aus Home Assistant?** → [Home Assistant](../anleitungen/home-assistant.md)
...
- **Wie rechnet die Prognose genau?** →
  [Grundlagen & Methodik](../verstehen/00-overview.md)
- **Öl/Pellets statt Gas?** → [Heizöl](../verstehen/05-heizoel.md) ·
