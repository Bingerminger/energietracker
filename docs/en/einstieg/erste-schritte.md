...
**English** · [Deutsch](../../einstieg/erste-schritte.md)
...
Apache, nginx — are in [Installation](../betrieb/installation.md) and
[Docker](../betrieb/docker.md).)
...
- **Insights → Analysis:** consumption against heating degree days (heating
  signature), with a regression line and R² comparison of five models.
...
- **Values automatically from Home Assistant?** → [Home Assistant](../anleitungen/home-assistant.md)
- **My case is more specific (shared flat, PV, landlord)?** →
  [Use cases](../anleitungen/anwendungsfaelle.md)
- **How exactly does the forecast compute?** →
  [Fundamentals & methodology](../verstehen/00-overview.md)
- **Oil/pellets instead of gas?** → [Heating oil](../verstehen/05-heizoel.md) ·
  [Pellets](../verstehen/06-pellets.md)
