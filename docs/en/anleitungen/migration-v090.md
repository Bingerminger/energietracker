...
**English** · [Deutsch](../../anleitungen/migration-v090.md)
  ...
  "data": {
    ...
    "report": {
      ...
      "device_replacement_candidates": [
        { "utility": "strom", "reading_id": "...", "date": "2024-01-10", "counter": 6, "comment": "Zählerwechsel", "reason": "Keyword detected in the comment" }
      ]
    }
  }
}
