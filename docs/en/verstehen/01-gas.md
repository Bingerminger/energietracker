...
**English** · [Deutsch](../../verstehen/01-gas.md)
...
| Billing unit | kWh |
| Conversion | `gas_conversion_factors` — dated list (volume correction factor × calorific value per effective date), since v2.5.0 |
...
## Conversion factors with effective dates (F1012, since v2.5.0)
...
- **Day-exact.** If an effective date falls inside a reading interval, the
