...
Beide Harnesses geben Exit-Code 0 bei Erfolg. Stand v2.13.0:
...
README-Abzeichen — `ReleaseConsistencyTest` zählt sie nach (v2.13.0: 448).
...
Prüfung auf literale Schlüssel sieht sie nicht.
