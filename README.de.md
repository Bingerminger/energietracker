...
[![Tests](https://img.shields.io/badge/Tests-254-success.svg)](tests/)
...
> **Status:** v2.5.1 ist die aktuelle öffentliche Version (initial release war v1.0.2). Wer aus einem privat
...
docker run -d --name energietracker -p 8080:80 \
  -v "$PWD/data:/data" \
  ghcr.io/bingerminger/energietracker:2.5.1
```
