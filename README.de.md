...
[![Tests](https://img.shields.io/badge/Tests-256-success.svg)](tests/)
...
> **Status:** v2.5.2 ist die aktuelle öffentliche Version (initial release war v1.0.2). Wer aus einem privat
...
> *Einstellungen → Sprache*. Die Dokumentation wird zweisprachig gepflegt
...
docker run -d --name energietracker -p 8080:80 \
  -v "$PWD/data:/data" \
  ghcr.io/bingerminger/energietracker:2.5.2
```
